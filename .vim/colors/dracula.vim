...
let s:bglight   = ['#2C2F33', 237]
let s:bg        = ['#2C2F33', 236]
let s:bgdark    = ['#21222C', 236]
...
let s:sky       = ['#FFFFFF', 111]
let s:darkcyan  = ['#FFFFFF', 158]
...
call s:h('DraculaDarkCyan', s:darkcyan)
...
hi! link Conditional DraculaPurple
hi! link Repeat DraculaDarkCyan
hi! link Exception DraculaYellow
hi! link Dot DraculaRed
hi! link pyStatement DraculaPink

"ANSI C POSIX C
hi! link BuiltinFunc DraculaDarkCyan  
hi! link PosixFunc DraculaDarkCyan
...
hi! link vimOption DraculaCyan
hi! link vimAutoEventList DraculaCyan
hi! link vimAutoCmdSfxList DraculaCyan
